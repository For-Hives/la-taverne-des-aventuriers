...
export default function CocktailVersusComponent({
	...
	return (
		<div className='flex h-fit w-full items-stretch justify-center gap-4 px-20 font-cardoRegular text-lg text-customBrown-100 max-md:flex-col max-md:px-2'>
			{/* Column 1 */}
			<div className='relative flex h-fit min-h-screen gap-9 w-1/2 flex-col items-center justify-center max-md:w-full max-md:gap-20'>
