...
export const AnimatedGameComponent = ({ data }: { data: GamesPageData }) => {
	return (
		<div className='flex min-h-fit h-screen w-3/4 flex-col items-start gap-9 max-lg:w-full max-lg:px-4'>
			{/* Title Section */}
			<motion.h2
			...
			<div className='flex h-full w-full items-center gap-2 max-lg:flex-col'>
				{/* First Card */}
				<motion.div
					className='relative flex h-full w-1/2 flex-col flex-wrap items-start justify-end gap-2 rounded-lg bg-gl-card1-bg bg-cover bg-center font-obraletra text-customWhite-100 max-lg:w-full max-lg:px-4 max-lg:min-h-[70vh]'
				...
				<div className='flex h-full w-1/2 flex-col items-center gap-2 text-customWhite-100 max-lg:w-full '>
					{/* Second Card */}
					<motion.div
						className='relative flex h-1/2 w-full flex-col flex-wrap items-start justify-end gap-2 rounded-lg bg-gl-card2-bg bg-cover bg-center max-lg:w-full max-lg:px-4 max-lg:min-h-[70vh]'
					...
					{/* Third Card */}
					<motion.div
						className='relative flex h-1/2 w-auto flex-col flex-wrap items-start justify-end gap-2 rounded-lg bg-gl-card3-bg bg-cover bg-center max-lg:w-full max-lg:px-4 overflow-hidden max-lg:min-h-[70vh]'
