 ...
 */
import type { NavBarData } from '@/app/actions/services/getNavData.service'
		...
		<nav className="fixed top-0 z-50 w-full xl:hidden">
			...
			<div className="border-custom-brown-100 bg-custom-white-100 relative z-50 mx-auto flex items-center justify-between border-b px-4 py-3">
				...
				<Link href="/" aria-label="Home">
					<Image src="/assets/images/LTDALogo.webp" alt="Website Logo" width={50} height={50} priority />
				</Link>
				...
				>
					<FontAwesomeIcon icon={isMenuOpen ? faTimes : faBars} className="text-custom-brown-100 h-6 w-6" />
				</button>
			</div>
			...
			>
				<div className="flex h-full flex-col items-center justify-center">
					...
					>
						<FontAwesomeIcon icon={faTimes} className="text-custom-brown-100 h-6 w-6" />
					</button>
