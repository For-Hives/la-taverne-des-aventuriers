...
export const AnimatedReservationCard = ({ data }: { data: ReservationCardData }) => {
	return (
		// Outer container with animation for fade-in effect
		<motion.div
			className='mx-auto border-3 border-customBrown-100 flex w-3/4 flex-col items-center gap-8 rounded bg-customWhite-300 p-4 sm:flex-row sm:gap-20 sm:p-10'
