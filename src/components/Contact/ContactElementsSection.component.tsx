...
const ContactElements = () => {
	return (
		<div className='flex w-3/4 gap-20 font-obraletra text-base text-title-200'>
			<div className='flex h-full w-1/2 flex-wrap items-center justify-start'>
				<div className='bg-title-600 flex w-1/2 flex-col items-start justify-center gap-9 rounded border-3 border-title-200'>
				...
				<div className='flex w-1/2 flex-col justify-start'>
					<div className='bg-title-600 flex h-fit flex-col items-start gap-6 rounded border-3 border-title-200'>
					...
					<div className='bg-title-600 flex h-fit flex-col items-start gap-9 rounded border-3 border-title-200'>
